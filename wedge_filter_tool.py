...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.slider_view.setMaximum(400)
        self.slider_view.setMinimum(20)
        
        self.tableWidget.initUI('')
        
        # self.comboBox_sort.addItems(self.tableWidget.getHeader())
        self.edit_node.setText('/out/wedge1')
        self.statusbar.showMessage('Ready')

        # fileMenu = self.menubar.addMenu('File')
        # openMenu = self.menubar.addMenu('Open')
        ...
        self.comboBox_sort.currentIndexChanged.connect(self.sortchange)
        ...
        self.comboBox_sort.setEnabled(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sortlabel.setText(QApplication.translate("MainWindow", "sort by", None, -1))
    ...
    def retranslateUiCN(self, MainWindow):
        ...
        self.sortlabel.setText(QApplication.translate("MainWindow", "排序依据", None, -1))
    ...
    def sortchange(self,i):
        self.tableWidget.sortItems(i)
        for count in range(self.comboBox_sort.count()):
            print( 'item'+str(count) + '='+ self.comboBox_sort.itemText(count) )
            print( "Current index",i,"selection changed ",self.comboBox_sort.currentText() )
    ...
    def nextfilter(self):
        ...
        # print files
        # print self.tableWidget.nextFilterItem()[3]
        if files != []:
...
class TableWidget(QTableWidget):
    def initUI(self, files):
        ...
        self.pictures=FileNameToWedge(files)
    ...
    def nextFilterItem(self):
        ...
        for i in range(len(self.pictures)):
            ...
            if self.pictures.isSelected(i):
                ...
                indexes.append(i)
        return oldfiles, newfiles, self.isGridView, indexes
    ...
    def gridview(self):
        self.isGridView = 1
        self.selectIndexes = self.nextFilterItem()[3]
        self.clear()
        self.setColumnCount(self.width() / self.rowHeight(0))
        self.setRowCount(len(self.pictures)/self.columnCount()+1)
